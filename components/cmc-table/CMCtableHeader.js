  ...
  return (
    <tbody>
        <tr>
            ...
            <th><div className={styles.textIcon}><p className='mr-2'>Volume</p><Info/></div></th> <th><div className={styles.textIcon}><p className='mr-2'>Circulating Supply</p><Info/></div></th>
            <th>Last 7 days</th>
        </tr>
    </tbody>
  )
